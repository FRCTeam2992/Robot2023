...
public enum AutoStartPosition {
    ...
    LoadStationEnd("Load Station End",
            ...
            new Pose2d(ScoringGridConstants.autoStartXCoordMeters,
                    ...
                    Rotation2d.fromDegrees(0.0)),
            PathPlanner.loadPath("LoadStationInitialMove", new PathConstraints(.6, .4))),
    CenterLoadStationSide("Center Load Station Side",
            ...
            new Pose2d(ScoringGridConstants.autoStartXCoordMeters,
                    ...
                    Rotation2d.fromDegrees(0.0)),
            PathPlanner.loadPath("CenterLoadStationSideInitialMove", new PathConstraints(.6, .4))),
    WallEnd("Wall End",
            new Pose2d(ScoringGridConstants.autoStartXCoordMeters,
            ...
            new Pose2d(ScoringGridConstants.autoStartXCoordMeters,
                    ...
                    Rotation2d.fromDegrees(0.0)),
            PathPlanner.loadPath("WallInitialMove", new PathConstraints(.6, .4))),
    CenterWallSide("Center Wall Side",
            ...
            new Pose2d(ScoringGridConstants.autoStartXCoordMeters,
                    ScoringGridConstants.Blue.grid7CenterYMeters - ScoringGridConstants.conePoleOffsetYMeters,
                    Rotation2d.fromDegrees(0.0)),
            PathPlanner.loadPath("CenterWallSideInitialMove", new PathConstraints(.6, .4)));
