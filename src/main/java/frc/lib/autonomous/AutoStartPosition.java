...
public enum AutoStartPosition {
    ...
    LoadStationEnd("Load Station End",
            ...
            new Pose2d(ScoringGridConstants.autoStartXCoordMeters,
                    ...
                    Rotation2d.fromDegrees(0.0)),
            PathPlanner.loadPath("LoadStationInitialMove", new PathConstraints(.4, .4))),
    CenterLoadStationSide("Center Load Station Side",
            ...
            new Pose2d(ScoringGridConstants.autoStartXCoordMeters,
                    ...
                    Rotation2d.fromDegrees(0.0)),
            PathPlanner.loadPath("CenterLoadStationSideInitialMove", new PathConstraints(.4, .4))),
    WallEnd("Wall End",
            new Pose2d(ScoringGridConstants.autoStartXCoordMeters,
            ...
            new Pose2d(ScoringGridConstants.autoStartXCoordMeters,
                    ...
                    Rotation2d.fromDegrees(0.0)),
            PathPlanner.loadPath("WallInitialMove", new PathConstraints(.4, .4))),
